import {DateInput, ReferenceInput, SimpleForm, useRecordContext} from "react-admin";
...
export const JournalForm = () => {
  ...
  return (
    <SimpleForm sx={{maxWidth: 1024}}>
      <Typography variant="h4">{record && <span>Edit {record.id}</span> || 'Create Journal'}</Typography>
